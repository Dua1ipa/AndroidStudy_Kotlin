...
class MediaPlayerService : Service() {
    ...
    override fun onCreate() {
        ...
        val playIcon = Icon.createWithResource(baseContext, R.drawable.play)
        val pauseIcon = Icon.createWithResource(baseContext, R.drawable.pause)
        val stopIcon = Icon.createWithResource(baseContext, R.drawable.stop)
